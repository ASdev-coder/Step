...
class ReactiveBike: public IBike
{
public:
    virtual std::string getTitle() override
    {
        return "Reactive bike";
    }
};
...
class ReactiveBikeCreator : public Creator
{
public:
    virtual IBike* createBike() override            // FACTORY METHOD
    {
        return new ReactiveBike{};
    }
};
...
public:
    ...
    void setCreator(BType btype)
    {
        ...
        case BType::HARLEY:
            ...
            break;
        case BType::REACTIVE:
            this->creator = new ReactiveBikeCreator{};
            break;
        default:
...
int main()
{
    ...
    game->setCreator(BType::REACTIVE);
